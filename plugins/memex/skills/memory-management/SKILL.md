...
description: Two-tier memory system that makes Claude a workplace collaborator. Decodes shorthand, acronyms, nicknames, and internal language. CLAUDE.md for working memory, memory/ directory for the full knowledge base.
---
